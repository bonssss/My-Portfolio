  ...
  return (
    <section id="projects" className="py-20 md:py-32 relative overflow-hidden bg-background">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 md:gap-12 mb-24">
...
function ProjectCard({ project, index }: { project: any, index: number }) {
  ...
  return (
    <motion.div 
      ...
      viewport={{ once: true }}
      className="group relative aspect-auto md:aspect-square bg-background overflow-hidden flex flex-col p-6 md:p-12 hover:bg-muted/10 transition-colors min-h-[380px] md:min-h-0"
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        <div className="flex justify-between items-start mb-8">
          ...
          <div className="flex gap-4 md:opacity-0 md:group-hover:opacity-100 transition-all transform md:translate-y-4 md:group-hover:translate-y-0">
        ...
        <p className="text-muted-foreground font-mono text-sm max-w-sm mb-8 md:mb-12 line-clamp-3">
          {project.description}
        </p>

        <div className="mt-auto flex flex-wrap gap-2 pr-0 sm:pr-12">
        ...
        <div className="absolute bottom-6 right-6 md:bottom-12 md:right-12 group-hover:translate-x-2 transition-transform hidden sm:block">
